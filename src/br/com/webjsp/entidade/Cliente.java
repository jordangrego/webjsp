...
public class Cliente {
	...
	public Blob getFundoEspelho() {
		return fundoEspelho;
	}

	public void setFundoEspelho(Blob fundoEspelho) {
	...
	public String toString() {
		return "Cliente [idCliente=" + idCliente + ", idUsuario=" + idUsuario + ", razaoSocial=" + razaoSocial
				...
				+ ", tamanhoNumeroCaixa=" + tamanhoNumeroCaixa + ", logo=" + logo + ", fundoEspelho=" + fundoEspelho
				+ ", idTipoCodigoBarra=" + idTipoCodigoBarra + ", prazo_entrega=" + prazo_entrega + ", metaPaginasDia="
				+ metaPaginasDia + ", paginas_total_contrato=" + paginas_total_contrato + "]";
	}

	

	/*
	 * @Override public String toString() { return "Cliente [idCliente=" +
	 * idCliente + ", idUsuario=" + idUsuario + ", razaoSocial=" + razaoSocial +
	 * ", emailCliente=" + emailCliente + ", cnpj=" + cnpj + ", dataHora=" +
	 * dataHora + ", qtdCaixaPadrao=" + qtdCaixaPadrao + ", existeCaixaTriplex="
	 * + existeCaixaTriplex + ", percAprovacao=" + percAprovacao +
	 * ", tamanhoNumeroCaixa=" + tamanhoNumeroCaixa + ", logo=" +
	 * Arrays.toString(logo) + ", fundoEspelho=" + Arrays.toString(fundoEspelho)
	 * + ", idTipoCodigoBarra=" + idTipoCodigoBarra + ", prazo_entrega=" +
	 * prazo_entrega + ", paginas_total_contrato=" + paginas_total_contrato +
	 * ", getIdCliente()=" + getIdCliente() + ", getIdUsuario()=" +
	 * getIdUsuario() + ", getRazaoSocial()=" + getRazaoSocial() +
	 * ", getEmailCliente()=" + getEmailCliente() + ", getCnpj()=" + getCnpj() +
	 * ", getDataHora()=" + getDataHora() + ", getQtdCaixaPadrao()=" +
	 * getQtdCaixaPadrao() + ", isExisteCaixaTriplex()=" +
	 * isExisteCaixaTriplex() + ", getPercAprovacao()=" + getPercAprovacao() +
	 * ", getTamanhoNumeroCaixa()=" + getTamanhoNumeroCaixa() + ", getLogo()=" +
	 * Arrays.toString(getLogo()) + ", getFundoEspelho()=" +
	 * Arrays.toString(getFundoEspelho()) + ", getIdTipoCodigoBarra()=" +
	 * getIdTipoCodigoBarra() + ", getPrazo_entrega()=" + getPrazo_entrega() +
	 * ", getPaginas_total_contrato()=" + getPaginas_total_contrato() +
